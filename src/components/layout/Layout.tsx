...
const navigation = [
  ...
  { name: 'Field Service', href: '/field-service', icon: WrenchIcon, roles: ['employee', 'super_admin'] },
  { name: 'Accounting', href: '/accounting', icon: CalculatorIcon, roles: ['super_admin'] },
                    ...
                    <ul role="list" className="flex flex-1 flex-col gap-y-7">
                      ...
                      <li className="mt-auto">
                        <button
                          ...
                          className="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:text-primary hover:bg-gray-50 w-full"
                        >
